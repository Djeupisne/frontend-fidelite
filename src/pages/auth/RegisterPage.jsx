            ...
            <div style={{ display: step === 2 ? 'block' : 'none' }}>
              <div className="space-y-5">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div><label className="label" htmlFor="r-dateRencontre">Date de la rencontre</label><input {...register('dateRencontre')} id="r-dateRencontre" type="date" autoComplete="off" className="input" /></div>
                    <F label="Lieu de la rencontre" name="lieuRencontre" placeholder="Ville, lieu..." />
                  </div>
                </div>
